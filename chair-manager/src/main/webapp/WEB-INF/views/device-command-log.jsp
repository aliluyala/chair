...
<body>
	<div>
       ...
       &nbsp;&nbsp;<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'"  onclick="doSearchDeviceCommand()">查询</a>  
    </div>
    <table class="easyui-datagrid" id="deviceStatusLogList" title="设备日志列表" 
	       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/<%=chair%>/device/listDeviceCommandForPage',method:'post',pageSize:100,toolbar:toolbar,pageList:[30,100,200],queryParams:{deviceNo:''}">
	    <thead>
	        <tr>
	        	<th data-options="field:'ck',checkbox:true"></th>
	        	<th data-options="field:'id',width:60">ID</th>
	            <th data-options="field:'deviceNo',width:200">设备编号</th>
	            <th data-options="field:'commandType',width:70,formatter:formatCommandType">设备状态</th>
	            <th data-options="field:'commandDesc',width:500">设备状态描述</th>
...
function formatCommandType(val){
	return val == 1 ? "接收" : "发送" ;
}
...
//条件查询
function doSearchDeviceCommand(){
