...
<div id="rechargeAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/<%=chair%>/page/recharge/recharge-add'" style="width:800px;height:600px;padding:10px;">
        The window content.
</div>
