package com.chair.manager.mapper.plugin;
...
public interface ChairMapper<T> {
     ...
     * @return
     */
    @DeleteProvider(type = ChairMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @SelectProvider(type = ChairMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = ChairMapperProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = ChairMapperProvider.class, method = "dynamicSQL")
